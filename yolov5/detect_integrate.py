                ...
                for c in det[:, -1].unique():
                    ...
                    if label not in past_items:
                        with open("log.txt", "a") as f:
                            ...
                            if label == "person":
                                show_alert("Slow Down!", "There is a person.", True)
                    ...
                    if (n > 3):
                        # call the function to raise an audio alert
                        print(f"Drive cautioasly as {n} {label} detected!")
                        show_alert("Many People!", "Slow down a lot.", True)
